  ...
  return (
    <>
      ...
      <div className="relative flex items-center justify-center min-h-screen bg-black text-white overflow-hidden p-4">
        ...
        {/* Login Card */}
        <div className="relative border border-green-500 rounded-2xl p-8 w-full max-w-md space-y-6 shadow-2xl bg-black/80 backdrop-blur-md z-10">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full bg-green-500 hover:bg-green-600 text-white py-3 rounded-full font-semibold transition-all shadow-lg hover:shadow-green-500/20"
            >
              Login as Admin
            </button>
            <button
              ...
              className="w-full bg-transparent border-2 border-green-500 text-green-400 hover:bg-green-500/10 py-3 rounded-full font-semibold transition-all shadow-lg"
            >
              Login as Employee
            </button>
          </div>
